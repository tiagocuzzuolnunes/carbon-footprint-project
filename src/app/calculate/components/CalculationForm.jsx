...
const fieldsetStyle = "flex flex-col justify-center";
        ...
        <section className="grid place-items-center p-5">
            <form className="grid gap-8" action="/submit" method="POST">
                ...
                <fieldset className={`${divInputBaseStyle}`}>
                    ...
                    <input className={`${InputBoxBaseStyle}`} type="text" name="name" id="name" />
                </fieldset>

                <fieldset className={`${divInputBaseStyle}`}>
                    <label className={`${InputTitle}`} htmlFor="company">What is your company's name?</label>
                    <input className={`${InputBoxBaseStyle}`} type="text" name="company" id="company" />
                </fieldset>
                ...
                <fieldset className={`${divInputBaseStyle}`}>
                    ...
                    <div className={`${divInputBaseStyle}`}>
                        ...
                        <input className={`${InputBoxBaseStyle}`} type="text" id="groundSmallMileage" name="groundSmallMileage" />
                    </div>
                ...
                {/* <fieldset className={`${divInputBaseStyle}`}>
                        <label>What is the mileage...</label>
                        <input className={`${InputBoxBaseStyle}`} type="text" name="mileageVehicles" id="mileageVehicles" />
                    </fieldset> */}
                ...
                <fieldset className={`${divInputBaseStyle}`}>
                    ...
                    <input className={`${InputBoxBaseStyle}`} type="text" name="electrictyUse" id="electricityUse" />
                </fieldset>
                ...
                <fieldset>
                    ...
                    <div className={`${divInputBaseStyle}`}>
                        ...
                        <input className={`${InputBoxBaseStyle}`} type="text" name="waterUse" id="waterUse" />
                    </div>
